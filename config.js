...
module.exports = {
  ...
  MASKINPORTEN: {
    ...
    cert: process.env.MASKINPORTEN_CERT ? Buffer.from(process.env.MASKINPORTEN_CERT, 'base64').toString() : readFileSync('./data/public.pem', 'utf-8'),
    privateKey: process.env.MASKINPORTEN_PRIVATE_KEY ? Buffer.from(process.env.MASKINPORTEN_PRIVATE_KEY, 'base64').toString() : readFileSync('./data/private.key', 'utf-8'),
